    ...
    <div className="w-80vw mx-auto mt-8">
      <div className="relative">
        ...
        <div className="absolute inset-x-0 top-0 text-center p-4 text-white font-semibold">
          <p className="bg-gradient-to-b from-sfont1 to-sfont2 text-transparent bg-clip-text text-xl md:text-3xl lg:text-4xl text-right mr-20 font-bold " style={{ textShadow: '0 0 10px rgba(255, 229, 58, 0.5)', WebkitTextStroke: '0.5px #000000' }}>SKINS</p>
        </div>
      </div>
