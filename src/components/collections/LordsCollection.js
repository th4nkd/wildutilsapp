...
import BandImg from '../../assets/images/band3.png';
import { LordsData } from '../../assets/data/lordsData';

const LordsCollection = ({ marketData, walletData }) => {
  return (
      ...
      <div className='gap-1 p-6 border-2 border-accent1 rounded-b-lg'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
            {LordsData.map((unit) => {
              ...
              return (
                <LordCard key={unit.id} unit={unit} marketData={marketItem} walletData={walletItem} />
              );
            })}
        </div>
...
export default LordsCollection;
