  ...
  return (
    <nav className="bg-secondary border-b-4 border-accent1 ff">
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
        ...
        <button
          type="button"
          className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 ml-10"
        ...
        <div className={`w-full md:w-auto md:flex ${menuOpen ? 'block' : 'hidden'}`} id="navbar-default">
